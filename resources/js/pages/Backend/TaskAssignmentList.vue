        ...
        <div class="p-8 min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 relative">
            ...
            <div class="mb-6 p-6 bg-white rounded-xl shadow-md border border-gray-200">
                <div class="grid grid-cols-1 md:grid-cols-5 gap-1 items-end">
                    ...
                    <div>
                        ...
                        <Multiselect v-model="selectedStatus" :options="['Pending', 'Working', 'Complete', 'Cancelled']"
            ...
            <Dialog v-model:visible="showDialog" modal
                ...
                <div class="p-6 space-y-5" :class="{
                    ...
                    <div class="grid grid-cols-2 gap-6 text-sm">
                        <div
                            ...
                            <p class="mt-1 text-gray-700">
                                ...
                                <p v-html="selectedTask.task?.details"></p>
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p>
                                ...
                                <strong>Start:</strong> {{ selectedTask.start_date }}
                            </p>
                            <p>
                                <i class="pi pi-calendar-times text-gray-500 mr-2"></i>
                                <strong>End:</strong> {{ selectedTask.end_date || "—" }}
                            </p>
                            <p>
                    ...
                    <!-- Complete Note -->
                    <div v-if="selectedTask.complete_note"
                        class="bg-green-50 border-l-6 p-3 mt-2 border-green-500 rounded-lg shadow">
                        <p class="text-green-800 font-medium"><strong>Complete Note:</strong></p>
                        <p class="text-gray-700">{{ selectedTask.complete_note }}</p>
                    </div>
                </div>
